 ...
 * @param cb
 */
PageControl.prototype.man = function(headNode, bodyNode, cb)
{
    var self = this;
 ...
 * 任务列表
 */
PageControl.prototype.list = function(headNode, bodyNode, cb)
{
    var self = this;
    headNode.role = customerType.ADMIN.id;
    var backBodyNode = {};
            ...
            table.find(backBodyNode.cond, {}, options, function(err, data){
                if(data)
                {
                    for(var key in data.rst)
                    {
                        ...
                        set.type = cons.taskType.id[set.type];
                        set.status = cons.taskStatus.id[set.status];
                    }
