if(CurSite.COMP.AdminGoodsList == undefined) {

    var AdminGoodsList = function(config)
    {
        var self = this;
        ...
        self.url = './admin_goods_list.html';
        self._init();
    };

    AdminGoodsList.prototype._init = function()
    {
        var self = this;
     ...
     * @param index
     */
    AdminGoodsList.prototype.toPage = function(index)
    {
        var self = this;
        var url = self.url;
        var id = CurSite.createUUID();
     ...
     * @returns {{}}
     */
    AdminGoodsList.prototype.getCond = function()
    {
        var self = this;
        var cond = {};
        return cond;
     ...
     * 获得额外条件
     */
    AdminGoodsList.prototype.getAdd = function()
    {
        var self = this;
        var add = {};
        return add;
    ...
    CurSite.COMP.AdminGoodsList = AdminGoodsList;
}