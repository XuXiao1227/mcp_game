if(CurSite.COMP.AdminGoodsAdd == undefined) {

    var AdminGoodsAdd = function(config)
    {
        var self = this;
    ...
    AdminGoodsAdd.prototype._init = function()
    {
        var self = this;
     ...
     * @private
     */
    AdminGoodsAdd.prototype._getData = function()
    {
        var self = this;
        var data = {};
    ...
    AdminGoodsAdd.prototype._check = function(data)
    {
        return true;
    };
     ...
     * @param index
     */
    AdminGoodsAdd.prototype._toPage = function(url)
    {
        var self = this;
    ...
    CurSite.COMP.AdminGoodsAdd = AdminGoodsAdd;
}