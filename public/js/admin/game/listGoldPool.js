if(CurSite.COMP.AdminGameListGoldPool == undefined) {

    var AdminGameListGoldPool = function(config)
    {
        var self = this;
        ...
        self.url = './admin_game_listGoldPool.html';
        self._init();
    };

    AdminGameListGoldPool.prototype._init = function()
    {
        var self = this;
...
*/
     ...
     * @param index
     */
    AdminGameListGoldPool.prototype.toPage = function(index)
    {
        var self = this;
        var url = self.url;
        var id = CurSite.createUUID();
     ...
     * @returns {{}}
     */
    AdminGameListGoldPool.prototype.getCond = function()
    {
        var self = this;
        var cond = {};
     ...
     * 获得额外条件
     */
    AdminGameListGoldPool.prototype.getAdd = function()
    {
        var self = this;
        var add = {};
        return add;
    ...
    CurSite.COMP.AdminGameListGoldPool = AdminGameListGoldPool;
}